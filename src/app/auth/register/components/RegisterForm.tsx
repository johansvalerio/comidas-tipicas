...
function RegisterForm() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen items-center justify-center p-4 sm:p-8 md:p-12 lg:p-24 gap-3 bg-cover">
      <div
        className='absolute inset-0 bg-[url("/img/maiz2.png")] bg-cover bg-center -z-10'
        style={{
          filter: "blur(10px)",
          transform: "scale(1.02)",
        }}
      />
      <div className="w-full max-w-sm px-4 py-6 bg-black/90 shadow-lg rounded-2xl text-black backdrop-blur-sm">
        <h1 className="text-xl text-white mb-3 flex justify-start items-baseline gap-1 font-medium">
          Registro de usuario{" "}
          <svg
        ...
        <form className="flex flex-col space-y-3" onSubmit={onSubmit}>
          <label
            htmlFor="user_name"
            className="font-semibold opacity-80 text-white"
          >
            Name
          </label>
          <input
          ...
          <div className="flex justify-center items-center gap-3 pt-3 font-medium">
            <button
              type="submit"
              className="text-center rounded-md md:p-3 p-2 text-md bg-amber-400 text-black font-semibold hover:bg-amber-300"
            >
              Crear usuario
            </button>
            <a
              href="/auth/login"
              className="text-center rounded-md md:p-3 p-2 font-medium text-md border border-gray-700 bg-gray-700 text-white hover:bg-gray-600 hover:border-gray-600"
            >
              Iniciar sesión
            </a>
          </div>
